...
\input{kapitel/grundlagen}          %% Hackintosh, Flutter, SQLite vs. MongoDB
\input{kapitel/methodik}            %% Schichtenarchitektur, Relationales Modell
\input{kapitel/implementierung}     %% Boot-Animation, 3D, QR-Scanner, SQLite-Code
\input{kapitel/evaluation}          %% Performance auf Samsung A3, Tests
\input{kapitel/fazit}               %% Zusammenfassung & Ausblick
...
\begin{appendices}
  \chapter{Quellcode-Dokumentation} %% Wichtig: Hier deinen DatabaseHelper-Code rein!
  \input{anlagen/listings}
\end{appendices}
